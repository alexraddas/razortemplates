...
module ProjectRazor
  module ModelTemplate
    # Root Model object
    # @abstract
    class Ubuntu32bit < ProjectRazor::ModelTemplate::Base
      ...
      def initialize(hash)
        ...
        @name = "ubuntu 32bit generic"
        @description = "Ubuntu 32bit Generic Model"
        # Metadata vars
        @hostname_prefix = nil
      ...
      def boot_call(node, policy_uuid)
        ...
        case @current_state
          when :init, :preinstall
            @result = "Starting Ubuntu 32bit model install"
